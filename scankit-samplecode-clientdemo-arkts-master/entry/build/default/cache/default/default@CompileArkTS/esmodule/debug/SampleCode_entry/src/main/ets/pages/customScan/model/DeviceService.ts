...
export class DeviceService {
    ...
    public static setDisplayInfo(displayClass: display.Display | null): void {
        if (displayClass !== null) {
            ...
            Logger.info(TAG, `setDisplayInfo, width: ${DeviceService.width}, height: ${DeviceService.height}, rotation: ${DeviceService.rotation}, densityPixels: ${DeviceService.densityPixels}`);
        }
    }
    ...
    public static selectSuitableRatio(): void {
        ...
        if (DeviceService.widthPX === 0 || DeviceService.heightPX === 0) {
            Logger.info(TAG, `The width or height of the display are abnormal. widthPX : ${DeviceService.widthPX}, heightPX : ${DeviceService.heightPX}`);
            return;
        }

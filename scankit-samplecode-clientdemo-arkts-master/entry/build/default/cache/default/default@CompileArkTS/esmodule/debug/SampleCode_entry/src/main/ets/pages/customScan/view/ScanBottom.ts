...
interface ScanBottom_Params {
    scanService?: ScanService;
    scanLayout?: ScanLayout;
    enableAlbum?: boolean;
    openPicker?: () => void;
}
interface FlashLight_Params {
    scanService?: ScanService;
    isLargeScreen?: boolean;
}
import { IconPress } from "@bundle:com.example.scanSample/SampleCode_entry/ets/pages/customScan/view/IconPress";
...
import { ScanService } from "@bundle:com.example.scanSample/SampleCode_entry/ets/pages/customScan/model/ScanService";
...
function __Column__componentColumnContainer(currentBreakpoint: string): void {
    ...
    Column.padding({
        left: new BreakpointType({ "id": 16777283, "type": 10002, params: [], "bundleName": "com.example.scanSample", "moduleName": "SampleCode_entry" }, { "id": 16777282, "type": 10002, params: [], "bundleName": "com.example.scanSample", "moduleName": "SampleCode_entry" }, { "id": 16777281, "type": 10002, params: [], "bundleName": "com.example.scanSample", "moduleName": "SampleCode_entry" }).getValue(currentBreakpoint),
        right: new BreakpointType({ "id": 16777283, "type": 10002, params: [], "bundleName": "com.example.scanSample", "moduleName": "SampleCode_entry" }, { "id": 16777282, "type": 10002, params: [], "bundleName": "com.example.scanSample", "moduleName": "SampleCode_entry" }, { "id": 16777281, "type": 10002, params: [], "bundleName": "com.example.scanSample", "moduleName": "SampleCode_entry" }).getValue(currentBreakpoint)
    });
}
...
export class FlashLight extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__isLargeScreen = new SynchedPropertySimpleOneWayPU(params.isLargeScreen, this, "isLargeScreen");
        this.setInitiallyProvidedValue(params);
        this.finalizeConstruction();
    }
    setInitiallyProvidedValue(params: FlashLight_Params) {
        if (params.scanService !== undefined) {
            this.scanService = params.scanService;
        }
    }
    updateStateVars(params: FlashLight_Params) {
        this.__isLargeScreen.reset(params.isLargeScreen);
    }
    ...
    private __isLargeScreen: SynchedPropertySimpleOneWayPU<boolean>;
    get isLargeScreen() {
...
export class ScanBottom extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
        ...
        this.__enableAlbum = new SynchedPropertySimpleOneWayPU(params.enableAlbum, this, "enableAlbum");
        this.openPicker = () => {
        };
        this.setInitiallyProvidedValue(params);
        this.finalizeConstruction();
    }
    setInitiallyProvidedValue(params: ScanBottom_Params) {
        if (params.scanService !== undefined) {
            this.scanService = params.scanService;
        }
        ...
        if (params.enableAlbum === undefined) {
            this.__enableAlbum.set(false);
        }
        if (params.openPicker !== undefined) {
            this.openPicker = params.openPicker;
        }
    }
    updateStateVars(params: ScanBottom_Params) {
        this.__enableAlbum.reset(params.enableAlbum);
    }
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        this.__scanService.purgeDependencyOnElmtId(rmElmtId);
        this.__scanLayout.purgeDependencyOnElmtId(rmElmtId);
        this.__enableAlbum.purgeDependencyOnElmtId(rmElmtId);
    }
    aboutToBeDeleted() {
        this.__scanService.aboutToBeDeleted();
        this.__scanLayout.aboutToBeDeleted();
        this.__enableAlbum.aboutToBeDeleted();
        SubscriberManager.Get().delete(this.id__());
        this.aboutToBeDeletedInternal();
    }
    private __scanService: ObservedPropertyObjectPU<ScanService>;
    ...
    private __enableAlbum: SynchedPropertySimpleOneWayPU<boolean>;
    get enableAlbum() {
        return this.__enableAlbum.get();
    }
    set enableAlbum(newValue: boolean) {
        this.__enableAlbum.set(newValue);
    }
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                ...
                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/customScan/view/ScanBottom.ets", line: 118, col: 7 });
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    FlashLight(this, {
                        isLargeScreen: false
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/customScan/view/ScanBottom.ets", line: 133, col: 7 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            isLargeScreen: false
            ...
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new FlashLight(this, {
                        isLargeScreen: true
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/customScan/view/ScanBottom.ets", line: 161, col: 7 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            isLargeScreen: true

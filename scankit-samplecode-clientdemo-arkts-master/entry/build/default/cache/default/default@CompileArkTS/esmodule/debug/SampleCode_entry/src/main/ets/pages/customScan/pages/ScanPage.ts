...
import { ScanLine } from "@bundle:com.example.scanSample/SampleCode_entry/ets/pages/customScan/view/ScanLine";
import { ScanBottom } from "@bundle:com.example.scanSample/SampleCode_entry/ets/pages/customScan/view/ScanBottom";
import { CodeLayout } from "@bundle:com.example.scanSample/SampleCode_entry/ets/pages/customScan/view/CommonCodeLayout";
import { ScanTitle } from "@bundle:com.example.scanSample/SampleCode_entry/ets/pages/customScan/view/ScanTitle";
import { PromptTone } from "@bundle:com.example.scanSample/SampleCode_entry/ets/pages/customScan/model/PromptTone";
import { openAlbum } from "@bundle:com.example.scanSample/SampleCode_entry/ets/pages/customScan/model/OpenPhoto";
...
import { MaskLayer } from "@bundle:com.example.scanSample/SampleCode_entry/ets/pages/customScan/view/MaskLayer";
...
import { ScanXComponent } from "@bundle:com.example.scanSample/SampleCode_entry/ets/pages/customScan/view/ScanXComponent";
import { ScanLoading } from "@bundle:com.example.scanSample/SampleCode_entry/ets/pages/customScan/view/ScanLoading";
...
class ScanPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__tipShow = new ObservedPropertySimplePU(false, this, "tipShow");
        ...
        this.__scanResult = new ObservedPropertyObjectPU(this.scanService.scanResult, this, "scanResult");
        this.__densityDPI = new ObservedPropertySimplePU(0, this, "densityDPI");
        this.__viewControl = new ObservedPropertyObjectPU({
            width: this.xComponentService.width,
            height: this.xComponentService.height,
            surfaceId: this.xComponentService.surfaceId
        }, this, "viewControl");
        this.__userGrant = new ObservedPropertySimplePU(false, this, "userGrant");
        this.options = {
        ...
        this.dialogController = new CustomDialogController({
            builder: () => {
                let jsDialog = new CommonTipsDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/pages/customScan/pages/ScanPage.ets", line: 77, col: 14 });
    ...
    setInitiallyProvidedValue(params: ScanPage_Params) {
        if (params.tipShow !== undefined) {
            this.tipShow = params.tipShow;
        }
        ...
        if (params.densityDPI !== undefined) {
            this.densityDPI = params.densityDPI;
        }
        if (params.viewControl !== undefined) {
            this.viewControl = params.viewControl;
        }
        if (params.userGrant !== undefined) {
            this.userGrant = params.userGrant;
        }
        ...
        if (params.photoPickerCallback !== undefined) {
            this.photoPickerCallback = params.photoPickerCallback;
        }
        if (params.customScanCallback !== undefined) {
            this.customScanCallback = params.customScanCallback;
        }
    }
    updateStateVars(params: ScanPage_Params) {
    }
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        this.__tipShow.purgeDependencyOnElmtId(rmElmtId);
        ...
        this.__densityDPI.purgeDependencyOnElmtId(rmElmtId);
        this.__viewControl.purgeDependencyOnElmtId(rmElmtId);
        this.__userGrant.purgeDependencyOnElmtId(rmElmtId);
    }
    aboutToBeDeleted() {
        this.__tipShow.aboutToBeDeleted();
        ...
        this.__densityDPI.aboutToBeDeleted();
        this.__viewControl.aboutToBeDeleted();
        this.__userGrant.aboutToBeDeleted();
        SubscriberManager.Get().delete(this.id__());
        this.aboutToBeDeletedInternal();
    }
    private __tipShow: ObservedPropertySimplePU<boolean>; // Determine whether to display the message indicating that no barcode is recognized.
    get tipShow() {
        return this.__tipShow.get();
    }
    set tipShow(newValue: boolean) {
        this.__tipShow.set(newValue);
    }
    ...
    private __scanResult: ObservedPropertyObjectPU<ScanResults>;
    get scanResult() {
        return this.__scanResult.get();
    }
    set scanResult(newValue: ScanResults) {
        this.__scanResult.set(newValue);
    }
    private __densityDPI: ObservedPropertySimplePU<number>; // Pixel density.
    get densityDPI() {
        return this.__densityDPI.get();
    }
    set densityDPI(newValue: number) {
        this.__densityDPI.set(newValue);
    }
    private __viewControl: ObservedPropertyObjectPU<customScan.ViewControl>;
    get viewControl() {
        return this.__viewControl.get();
    }
    set viewControl(newValue: customScan.ViewControl) {
        this.__viewControl.set(newValue);
    }
    private __userGrant: ObservedPropertySimplePU<boolean>; // Check whether the camera permission is granted.
    get userGrant() {
        return this.__userGrant.get();
    }
    set userGrant(newValue: boolean) {
        this.__userGrant.set(newValue);
    }
    ...
    private photoPickerCallback: AsyncCallback<scanBarcode.ScanResult[]>;
    private customScanCallback: AsyncCallback<scanBarcode.ScanResult[]>;
    aboutToAppear() {
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/customScan/pages/ScanPage.ets", line: 167, col: 5 });
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new ScanLoading(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/customScan/pages/ScanPage.ets", line: 177, col: 7 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {};
                                };
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/customScan/pages/ScanPage.ets", line: 185, col: 7 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            scanResultSize: this.scanResult.size
            ...
            if (this.scanService.scanStatus === ScanStatus.PREVIEW_DECODING) {
                this.ifElseBranchUpdateFunction(0, () => {
                    ...
                    }, __Common__);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new ScanLine(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/customScan/pages/ScanPage.ets", line: 205, col: 9 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {};
                                };
    ...
    ScanBottomBuilder(parent = null) {
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/customScan/pages/ScanPage.ets", line: 219, col: 5 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            enableAlbum: this.options.enableAlbum,
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new MaskLayer(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/customScan/pages/ScanPage.ets", line: 238, col: 7 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {};
                                };
                    ...
                    }, Column);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                ...
                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/customScan/pages/ScanPage.ets", line: 247, col: 9 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        scanResults: this.scanResult,
...
if (UIContextSelf.getSharedLocalStorage() && UIContextSelf.getSharedLocalStorage().routeName != undefined && UIContextSelf.getSharedLocalStorage().storage != undefined) {
    registerNamedRoute(() => new ScanPage(undefined, {}, UIContextSelf.getSharedLocalStorage().useSharedStorage ? LocalStorage.getShared() : UIContextSelf.getSharedLocalStorage().storage), UIContextSelf.getSharedLocalStorage().routeName, { bundleName: "com.example.scanSample", moduleName: "SampleCode_entry", pagePath: "pages/customScan/pages/ScanPage", pageFullPath: "entry/src/main/ets/pages/customScan/pages/ScanPage", integratedHsp: "false", moduleType: "followWithHap" });
}
    ...
    registerNamedRoute(() => new ScanPage(undefined, {}, UIContextSelf.getSharedLocalStorage().useSharedStorage ? LocalStorage.getShared() : UIContextSelf.getSharedLocalStorage().storage), "", { bundleName: "com.example.scanSample", moduleName: "SampleCode_entry", pagePath: "pages/customScan/pages/ScanPage", pageFullPath: "entry/src/main/ets/pages/customScan/pages/ScanPage", integratedHsp: "false", moduleType: "followWithHap" });
}
else if (UIContextSelf.getSharedLocalStorage() && UIContextSelf.getSharedLocalStorage().useSharedStorage != undefined) {
    registerNamedRoute(() => new ScanPage(undefined, {}, UIContextSelf.getSharedLocalStorage().useSharedStorage ? LocalStorage.getShared() : undefined), "", { bundleName: "com.example.scanSample", moduleName: "SampleCode_entry", pagePath: "pages/customScan/pages/ScanPage", pageFullPath: "entry/src/main/ets/pages/customScan/pages/ScanPage", integratedHsp: "false", moduleType: "followWithHap" });
}
else {
    registerNamedRoute(() => new ScanPage(undefined, {}, UIContextSelf.getSharedLocalStorage()), "", { bundleName: "com.example.scanSample", moduleName: "SampleCode_entry", pagePath: "pages/customScan/pages/ScanPage", pageFullPath: "entry/src/main/ets/pages/customScan/pages/ScanPage", integratedHsp: "false", moduleType: "followWithHap" });
}

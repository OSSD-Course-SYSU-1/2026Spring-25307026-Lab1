    ...
    public static setUIContext(windowObj: window.Window): void {
        if (windowObj) {
            try {
                ...
                Logger.info(TAG, 'Succeeded in getting getUIContext.');
            }
            catch (error) {
